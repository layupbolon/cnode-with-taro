								...
								<View className="replyContainer">
									...
									<View className="replyDetail">
										...
										<View className="icons">
											<View className='zan'>
												<Icon iconType={'dianzan'} iconColor={'#000000'} fontSize={18} />
												<Text>{item.ups.length ? item.ups.length : ''}</Text>
											</View>
											<View>
												<Icon iconType={'huifu'} iconColor={'#000000'} fontSize={18} />
											</View>
										</View>
									</View>
								</View>
